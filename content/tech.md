...
Webカメラを用いて手の骨格を認識することで実体のないマウスの開発に成功. 技育展2021にて開発スキル支援部門で優秀賞受賞. [GitHub](https://github.com/takeyamayuki/NonMouse2), [Zenn](https://zenn.dev/ninzin/articles/94b05fdb9edf53), [Youtube](https://youtu.be/ufvOJUTCF8M)
...
Raspberry Pi, ESP32を用いて家のIoT化を行った. メイン処理部分にはHomekitエミュレータのHomebridgeをインストールしたRaspberry Piを使用し, リモコン操作も可能にした. 壁付けスイッチの操作のために, Switchbotを模した[RESTful-servo-motor](https://github.com/takeyamayuki/RESTful-servo-motor)を開発した. 
...
{{< image src="https://user-images.githubusercontent.com/22733958/174475758-7b7a80c3-e7e6-4ea8-a183-bde589b0c9f9.gif" position="center" style="width:70%; border-radius: 8px;" >}}  
